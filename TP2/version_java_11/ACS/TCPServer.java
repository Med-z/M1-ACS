...
class ServerProcess implements Runnable {
    ...
    private void handleTimeRequest(ClientDataZone data, DataOutputStream dataoutput)
    ...
    private void handleChangeLangRequest(ClientDataLanguage data, DataOutputStream dataoutput)
            throws Exception, LanguageUnknownExeption {
...
public class TCPServer {
    ...
    static public void launch(int port) {
        try {
            ...
            // maximum client the server can handle
